...
export default function QuotePage() {
  return (
    <InteriorPage
      ...
      title={<>Biết trước mức phí.<br /><span className="text-[#0066cc]">Chọn đúng lớp bảo vệ.</span></>}
    ...
    >
      ...
      <section className="border-t border-[#cce0f5] bg-[#eef6ff]">
        <div className="mx-auto max-w-[1240px] px-5 py-12 lg:px-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <p className="text-[12px] font-bold uppercase tracking-[0.14em] text-[#0066cc]">LƯU Ý VỀ BÁO GIÁ</p>
              <h2 className="mt-2 text-[22px] font-bold text-[#0b2341]">Mức phí trên là số liệu minh họa</h2>
            </div>
            <p className="max-w-2xl text-[14px] leading-6 text-[#4a6785]">
