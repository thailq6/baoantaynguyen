...
export default function FaqPage() {
  const rows = [
    ...
    ["Khi xảy ra tai nạn va chạm, tôi cần liên hệ ai?", "Bạn hãy giữ an toàn, chụp ảnh hiện trường và gọi Hotline BIC 1900 9456 hoặc liên hệ SĐT hỗ trợ 0916 201 085 để được hướng dẫn xử lý bồi thường kịp thời."],
  ...
  return (
    <InteriorPage
      ...
      intro="Nếu chưa thấy câu trả lời bạn cần, hãy kết nối ngay qua SĐT 0916 201 085 hoặc nhắn tin Zalo Bảo An Tây Nguyên."
    >
